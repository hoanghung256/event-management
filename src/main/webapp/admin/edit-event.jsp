                            ...
                            <div class="create__event-main pt-25">
                                <div class="event__left-box">
                                    ...
                                    <div class="event__update-wrapper">
                                        <span>Add image</span>
                                        <br/>
                                        <span class="text-info">*Upload new image will delete all images are uploaded</span>
                                        <div class="event__update-file">
                                            <div class="event__update-thumb">
                                                <div class="box__input d-flex justify-content-center align-items-center">
                                                    <input type="file" name="images" id="file" class="box__file" multiple onchange="deletePreviousPreviewImg()">
                                                    <label class="input__field-text" for="file"><span><i class="fa-regular fa-plus"></i></span><span>Update Image</span></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="event__update-file" id="image-wrapper">
                                            <div class="event__image-preview">
                                                <c:forEach var="imagePath" items="${event.images}">
                                                    <div class="event__update-thumb">
