<%-- 
    ...
    Created on : Oct 11, 2024, 9:36:14?AM
    Author     : ThangNM
--%>
                        ...
                        <div class="breadcrumb__menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><span>Registration Events</span></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                                                ...
                                                                <div class="card__header-dropdown">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-list">
                                                                            <a class="dropdown__item" href="<c:url value="/admin/approval-events?action=detail&eventId=${event.id}"/>">Detail</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <c:forEach var="i" begin="0" end="${page.totalPage}">
                                                <c:choose>
                                                    <c:when test="${i == 0 && page.currentPage > 0}">
                                                        <li>
                                                            <a href="<c:url value="/admin/approval-events?action=show&page=${page.currentPage - 1}"/>">
                                                    ...
                                                    <c:when test="${i >= page.currentPage && i <= page.currentPage + 4}">
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <li>
                                                                    <a href="<c:url value="/admin/approval-events?action=show&page=${i}"/>">${i + 1}</a>
                                                                </li>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </c:when>
                                                    <c:when test="${i == page.currentPage + 5 && page.currentPage + 5 < page.totalPage - 1}">
                                                        ...
                                                        <li>
                                                            <a href="<c:url value="/admin/approval-events?action=show&page=${page.totalPage - 1}"/>">
                                                                ${page.totalPage}
                                                            </a>
                                                        </li>
                                                    </c:when>
