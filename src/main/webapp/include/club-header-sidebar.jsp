                ...
                <div class="sidebar__inner simple-bar">
                    <div class="dlabnav">
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="/club-dashboard" aria-expanded="false">
                            ...
                            <li>
                                <a href="register-event" aria-expanded="false">
                            ...
                            <li>
                                <a href="attendant-list.html" aria-expanded="false">
                                    ...
                                    <span class="nav-text">Send File To Admin</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/view-events" aria-expanded="false">
