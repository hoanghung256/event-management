<%-- 
    Document   : guest-register-success
    Created on : Nov 2, 2024, 9:11:35 PM
    Author     : hoang hung 
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Cảm ơn bạn đã đăng ký tham gia sự kiện <strong>[EventName]</strong>! Hân hạnh được chào đón bạn tham gia và trải nghiệm những điều tuyệt vời tại sự kiện.</p>
