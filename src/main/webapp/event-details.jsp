                                                ...
                                                <div class="tab-content" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                                                        ...
                                                        <div class="about__content mt-30">
                                                            ...
                                                            <p>khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt khiemmapdjt </p>
                                                        </div>
